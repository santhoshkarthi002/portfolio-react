              ...
              <div className="tl-card cur">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '10px', marginBottom: '14px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '6px' }}>
                    <span style={{ fontFamily: "'Space Mono',monospace", fontSize: '11px', color: '#556677', background: '#00e5ff08', border: '1px solid #00e5ff18', padding: '3px 10px', borderRadius: '4px' }}>Jul 2024 – Present</span>
            ...
            <div style={{ display: 'flex', gap: '22px', alignItems: 'flex-start' }}>
              ...
              <div className="tl-card">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '10px', marginBottom: '14px' }}>
                  ...
                  <span style={{ fontFamily: "'Space Mono',monospace", fontSize: '11px', color: '#556677', background: '#00e5ff08', border: '1px solid #00e5ff18', padding: '3px 10px', borderRadius: '4px', alignSelf: 'flex-start' }}>Mar 2022 – Jun 2024</span>
                </div>
                <ul style={{ listStyle: 'none', padding: 0 }}>
